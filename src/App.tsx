...
const App = () => {
  // ... (screenWidth, isMobile, listContent, handleChange, etc.)
  ...
  return (
    <section className="flex lg:flex-row flex-col-reverse justify-evenly text-white bg-white lg:h-[500px] rounded-md">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full border-1 ${
                    emailError ? "border-red-500 bg-red-50 text-red-500" : "border-black"
      ...
      <aside className="lg:w-1/2 w-full lg:px-8 lg:py-4 py-8 px-0">
        <img
